...
module.exports = (app, config) ->
  # 页面
  app.use require('../api/pages/default')
  app.use require('../api/pages/user')

  app.use '/api/*', (req, res, done) ->
    res.contentType "application/vnd.#{config.app.api_vnd}+json"
    done()

  # 接口
  app.use '/api/', require('../api/controllers/default')
  app.use '/api/projects', require('../api/controllers/project')
